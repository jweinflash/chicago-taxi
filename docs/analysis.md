...
[![Evening dropoffs](../plots/evening-dropoffs-small.png)](../plots/evening-dropoffs.png)
...
[![Community areas with most pickups](../plots/pickups-small.png)](../plots/pickups.png)

We can play the same game to see the areas that are the most common for dropoffs each quarter.

[![Community areas with most dropoffs](../plots/dropoffs-small.png)](../plots/dropoffs.png)

Or do it see the dropoffs that are most common in the evenings, weekdays versus weekends.

[![Community areas with most evening dropoffs](../plots/evening-dropoffs-small.png)](../plots/evening-dropoffs.png)
